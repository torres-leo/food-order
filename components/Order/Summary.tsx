			...
			{orderSideBar && (
				<AnimatePresence>
					<LazyMotion features={domAnimation} key='panel'>
						<motion.aside
							className='md:w-2/5 md:h-[85vh] lg:w-96 2xl:max-w-[450px] 2xl:w-full p-5 pl-3 bg-white/10 sb-g overflow-y-auto scrollbar xl:h-screen'
							{...motionOptions}>
							...
							<div
								className={`flex flex-col gap-y-2 rounded justify-start scrollbar overflow-y-auto pr-4 ${
									!order.length
										...
										: 'h-auto md:max-h-[calc(100%-450px)] lg:max-h-[calc(100%-350px)] mb-10'
								}`}>
								{renderOrder()}
							</div>
							{renderTotalOrder()}
